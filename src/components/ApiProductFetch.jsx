...
const ApiProductFetch = () => {
  ...
  return (
    <div>
      <div
        className={`mx-auto p-2 sticky top-2 z-[1] w-[120px] sm:w-[270px] md:w-[400px] lg:w-[600px] h-fit bg-theme-color shadow-[2px_2px_20px_rgba(0,0,0,0.08)] rounded-full flex items-center transition-all duration-300`}
      >
        <input
