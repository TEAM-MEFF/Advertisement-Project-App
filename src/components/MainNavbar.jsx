...
const MainNavbar = ({ totalAmount }) => {
	return (
		<div>
			<div>
				<div className="flex fixed top-0 left-0 z-10 py-2 w-full justify-between px-2 sm:px-4  bg-highlight border-b border-green-300 shadow-lg">
