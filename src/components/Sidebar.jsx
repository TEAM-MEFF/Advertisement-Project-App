...
const Sidebar = () => {
	return (
		<div className="flex flex-col items-start justify-start left-0 top-0 bg-green-200 h-full fixed">
			...
			<div className="flex flex-col transition-all duration-1000 ease-in-out">
				<Link
					to="/vendor"
					className="hover:text-white text-black  px-5 py-3 sm:text-base md:text-xl current:bg-slate-300 hover:bg-theme-color font-semibold rounded items-center"
				>
					<IonIcon
				...
				<Link
					to="/vendor"
					className="hover:text-white text-black  px-5 sm:text-base md:text-xl py-3 current:bg-slate-300 hover:bg-theme-color font-semibold rounded items-center"
				>
					<IonIcon
