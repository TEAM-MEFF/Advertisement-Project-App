                ...
                <div className='w-1/5'>
                    ...
                    <div className="flex flex-col items-start justify-start left-0 top-0 bg-blue-200 h-full fixed z-[1]">
                        ...
                        <div className='flex flex-col transition-all duration-1000 ease-in-out mt-1'>
                            <Link to="/vendordashboard" className="bg-theme-color text-white  px-5 py-3 sm:text-base md:text-xl current:bg-slate-300 hover:bg-blue-700 font-semibold items-center">
                                <IonIcon name="bar-chart-outline" className="text-xl md:text-2xl  my-auto align-middle items-center mb-1 pr-2 "
                                />Dashboard
                            </Link>
                            <Link to="/vendordashboard/myproducts" className="hover:text-white text-black  px-5 sm:text-base md:text-xl py-3 current:bg-slate-300 hover:bg-blue-700 font-semibold  items-center">
                                <IonIcon name="business-outline" className="text-xl md:text-2xl  my-auto align-middle items-center mb-1 pr-2 "
                                />My Store
                            </Link>
                            <Link to="/vendordashboard/postproduct" className="hover:text-white text-black  px-5 sm:text-base md:text-xl py-3 current:bg-slate-300 hover:bg-blue-700 font-semibold  items-center">
                                <IonIcon name="add-circle-outline" className="text-xl md:text-2xl  my-auto align-middle items-center mb-1 pr-2 "
                                />Post a Product
                            </Link>
                            <Link to="/vendordashboard" className="hover:text-white text-black  px-5 sm:text-base md:text-xl py-3 current:bg-slate-300 hover:bg-blue-700 font-semibold  items-center">
