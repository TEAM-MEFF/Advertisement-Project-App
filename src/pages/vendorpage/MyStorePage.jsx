                ...
                <div className='w-1/5'>
                    ...
                    <div className="flex flex-col items-start justify-start left-0 top-0 bg-blue-200 h-full fixed z-[1]">
                        ...
                        <div className='flex flex-col transition-all duration-1000 ease-in-out mt-1'>
                            ...
                            <Link to="/vendordashboard/myproducts" className="bg-theme-color text-white  px-5 py-3 sm:text-base md:text-xl current:bg-slate-300 hover:bg-blue-700 font-semibold  items-center">
