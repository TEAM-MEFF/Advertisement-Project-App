            ...
            <div>
                ...
                <div className="flex fixed w-full z-[1] top-0 items-center mx-auto justify-end py-2 px-10 bg-blue-200 ">
                    ...
                    <div className="flex items-center gap-1 md:gap-3">
                        <Link
                            to="/sign-up"
                            className=" flex gap-2 border-2 border-theme-color rounded-full -full px-2 py-1 text-center"
                        >
                ...
                <div className='w-1/5'>
                    ...
                    <div className="flex flex-col items-start justify-start left-0 top-0 bg-blue-200 h-full fixed z-[1]">
                        ...
                        <div className='flex flex-col transition-all duration-1000 ease-in-out mt-1'>
                            ...
                            <Link to="/vendordashboard/postproduct" className="bg-theme-color text-white  px-5 py-3 sm:text-base md:text-xl current:bg-slate-300 hover:bg-blue-700  font-semibold items-center">
